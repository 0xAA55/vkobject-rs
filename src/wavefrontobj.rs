...
impl ObjMaterial for ObjMaterialLegacy {
	...
	fn get_albedo(&self) ->			Option<&ObjMaterialComponent> {Some(&self.diffuse)}
	fn get_ao(&self) ->				Option<&ObjMaterialComponent> {Some(&self.ambient)}
...
impl ObjMaterial for ObjMaterialPbr {
	...
	fn get_ambient(&self) ->		Option<&ObjMaterialComponent> {Some(&self.ao)}
	fn get_diffuse(&self) ->		Option<&ObjMaterialComponent> {Some(&self.albedo)}
