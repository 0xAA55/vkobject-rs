...
impl Buffer {
	/// Create a new buffer
	pub fn new(device: Arc<VulkanDevice>, size: VkDeviceSize, data: *const c_void, usage: VkBufferUsageFlags, queue_index: usize) -> Result<Self, VulkanError> {
	...
	pub fn set_data(&self, data: *const c_void, offset: VkDeviceSize, length: VkDeviceSize, queue_index: usize) -> Result<(), VulkanError> {
